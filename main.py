...
from app.module_7_1 import router_module_7_1
from app.module_7_2 import router_module_7_2
from app.module_7_3 import router_module_7_3
...
async def main():
    ...
    dp.include_router(router_module_7_1)
    dp.include_router(router_module_7_2)
    dp.include_router(router_module_7_3)
